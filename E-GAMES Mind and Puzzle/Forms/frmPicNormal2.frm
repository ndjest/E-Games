...
Begin VB.Form frmPicNormal2 
   ...
   DrawWidth       =   8
   LinkTopic       =   "Form1"
   Picture         =   "frmPicNormal2.frx":0000
   ScaleHeight     =   527
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   741
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox picme 
         ...
         Begin VB.Image Image1 
            Height          =   3075
            Left            =   15
            MouseIcon       =   "frmPicNormal2.frx":15D62
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H80000009&
         Height          =   405
         ItemData        =   "frmPicNormal2.frx":15EB4
         Left            =   4440
         List            =   "frmPicNormal2.frx":15ED6
      ...
      Begin VB.Label NewGame 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicNormal2.frx":15F05
         MousePointer    =   99  'Custom
         TabIndex        =   18
         Top             =   480
         Width           =   2640
      ...
      Begin VB.Label SolvMe 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicNormal2.frx":1620F
         MousePointer    =   99  'Custom
         TabIndex        =   17
         Top             =   1560
         Width           =   2640
      ...
      Begin VB.Label Menu 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicNormal2.frx":16519
         MousePointer    =   99  'Custom
         TabIndex        =   16
         Top             =   6360
         Width           =   2640
      ...
      Begin VB.Image Image6 
         Height          =   1035
         Left            =   360
         Picture         =   "frmPicNormal2.frx":16823
         Top             =   120
         Width           =   2250
      End
      Begin VB.Image Image2 
         Height          =   1035
         Left            =   360
         Picture         =   "frmPicNormal2.frx":16A9B
         Top             =   1200
         Width           =   2250
      End
      Begin VB.Image Image7 
         Height          =   1035
         Left            =   480
         Picture         =   "frmPicNormal2.frx":16D31
         Top             =   6000
         Width           =   2250
      End
      ...
      Begin VB.Image Image5 
         Height          =   7350
         Left            =   0
         Picture         =   "frmPicNormal2.frx":16FA9
         Top             =   0
         Width           =   12555
      End
   ...
   Begin VB.PictureBox pic 
      ...
      Index           =   0
      Left            =   360
      MouseIcon       =   "frmPicNormal2.frx":19FB5
      MousePointer    =   99  'Custom
      ScaleHeight     =   76
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   76
   ...
   Begin PicClip.PictureClip Clip1 
      ...
      Rows            =   5
      Cols            =   5
      Picture         =   "frmPicNormal2.frx":1A2BF
   End
End
Attribute VB_Name = "frmPicNormal2"
...
With rs
    ...
    If .EOF = False Then
        .Fields("picpuzz").Value = 5
        .Update
    End If
End With
End If
puzzScore = puzzScore + 2500
