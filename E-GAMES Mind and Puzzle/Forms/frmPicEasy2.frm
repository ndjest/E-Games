...
Begin VB.Form frmPicEasy2 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox picme 
         ...
         Begin VB.Image Image1 
            Height          =   3075
            Left            =   15
            MouseIcon       =   "frmPicEasy2.frx":0000
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H80000009&
         Height          =   405
         ItemData        =   "frmPicEasy2.frx":0152
         Left            =   4440
         List            =   "frmPicEasy2.frx":0174
      ...
      Begin VB.Label NewGame 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicEasy2.frx":01A3
         MousePointer    =   99  'Custom
         TabIndex        =   16
         Top             =   360
         Width           =   2640
      ...
      Begin VB.Label SolvMe 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicEasy2.frx":04AD
         MousePointer    =   99  'Custom
         TabIndex        =   15
         Top             =   1560
         Width           =   2640
      ...
      Begin VB.Label Menu 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicEasy2.frx":0CC5
         MousePointer    =   99  'Custom
         TabIndex        =   20
         Top             =   6360
         Width           =   2640
   ...
   Begin VB.PictureBox pic 
      ...
      Index           =   0
      Left            =   360
      MouseIcon       =   "frmPicEasy2.frx":4253
      MousePointer    =   99  'Custom
      ScaleHeight     =   76
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   76
   ...
   Begin PicClip.PictureClip Clip1 
      ...
      Rows            =   5
      Cols            =   5
      Picture         =   "frmPicEasy2.frx":455D
   End
End
Attribute VB_Name = "frmPicEasy2"
...
Combo1.ListIndex = 2 'pila ka moves
...
With rs
    ...
    If .EOF = False Then
        .Fields("picpuzz").Value = 3
        .Update
    End If
End With
End If
puzzScore = puzzScore + 1500
