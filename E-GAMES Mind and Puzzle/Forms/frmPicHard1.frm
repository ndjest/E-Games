...
Begin VB.Form frmPicHard1 
   ...
   Begin VB.PictureBox pic 
      ...
      Index           =   0
      Left            =   360
      MouseIcon       =   "frmPicHard1.frx":0000
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H80000009&
         Height          =   405
         ItemData        =   "frmPicHard1.frx":030A
         Left            =   4440
         List            =   "frmPicHard1.frx":032C
      ...
      Begin VB.PictureBox picme 
         ...
         Begin VB.Image Image1 
            Height          =   3075
            Left            =   15
            MouseIcon       =   "frmPicHard1.frx":035B
            MousePointer    =   99  'Custom
            Stretch         =   -1  'True
      ...
      Begin VB.Label Menu 
         ...
         Height          =   375
         Left            =   240
         MouseIcon       =   "frmPicHard1.frx":04AD
         MousePointer    =   99  'Custom
         TabIndex        =   19
         Top             =   6360
         Width           =   2640
      ...
      Begin VB.Label SolvMe 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicHard1.frx":07B7
         MousePointer    =   99  'Custom
         TabIndex        =   18
         Top             =   1560
         Width           =   2640
      ...
      Begin VB.Label NewGame 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicHard1.frx":0FCF
         MousePointer    =   99  'Custom
         TabIndex        =   17
         Top             =   360
         Width           =   2640
   ...
   Begin PicClip.PictureClip Clip1 
      ...
      Rows            =   5
      Cols            =   5
      Picture         =   "frmPicHard1.frx":455D
   End
End
Attribute VB_Name = "frmPicHard1"
...
Combo1.ListIndex = 3 'pila ka moves
...
Opt_Click (3) 'Level option ni xa
ResetScreen
End Sub
...
With rs
    ...
    If .EOF = False Then
        .Fields("picpuzz").Value = 6
        .Update
    End If
End With
End If
puzzScore = puzzScore + 3000
