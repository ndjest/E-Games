...
Begin VB.Form frmPicEasy1 
   ...
   Begin VB.PictureBox pic 
      ...
      Index           =   0
      Left            =   360
      MouseIcon       =   "frmPicEasy1.frx":0000
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H80000009&
         Height          =   405
         ItemData        =   "frmPicEasy1.frx":030A
         Left            =   4440
         List            =   "frmPicEasy1.frx":032C
      ...
      Begin VB.PictureBox picme 
         ...
         Begin VB.Image Image1 
            Height          =   3075
            Left            =   15
            MouseIcon       =   "frmPicEasy1.frx":035B
            MousePointer    =   99  'Custom
            Stretch         =   -1  'True
      ...
      Begin VB.Label Menu 
         ...
         Height          =   375
         Left            =   555
         MouseIcon       =   "frmPicEasy1.frx":04AD
         MousePointer    =   99  'Custom
         TabIndex        =   20
         Top             =   6480
         Width           =   1920
      ...
      Begin VB.Label SolvMe 
         ...
         Height          =   375
         Left            =   435
         MouseIcon       =   "frmPicEasy1.frx":0A2F
         MousePointer    =   99  'Custom
         TabIndex        =   18
         Top             =   1680
         Width           =   2280
      ...
      Begin VB.Label NewGame 
         ...
         Height          =   375
         Left            =   195
         MouseIcon       =   "frmPicEasy1.frx":0FCF
         MousePointer    =   99  'Custom
         TabIndex        =   14
         Top             =   600
         Width           =   2640
   ...
   Begin PicClip.PictureClip Clip1 
      ...
      Rows            =   5
      Cols            =   5
      Picture         =   "frmPicEasy1.frx":455D
   End
End
Attribute VB_Name = "frmPicEasy1"
...
NewGame.ForeColor = &H1BF4FA
SolvMe.ForeColor = &H1BF4FA
Menu.ForeColor = &HFF&
End Sub
...
Opt_Click (1) 'Level option ni xa
ResetScreen
End Sub
...
'finish.Visible = True ': SolvMe.Enabled = False   'diri isumpay ang next level
...
With rs
    ...
    If .EOF = False Then
        .Fields("picpuzz").Value = 2
        .Update
    End If
End With
End If

puzzScore = puzzScore + 1000
...
Private Sub SolvMe_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
NewGame.ForeColor = &H1BF4FA
SolvMe.ForeColor = &HFF&
Menu.ForeColor = &H1BF4FA
End Sub
